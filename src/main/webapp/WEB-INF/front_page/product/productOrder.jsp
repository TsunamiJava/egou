...
<div class="w ofc case">
	...
	<div class="box bg_white">
		<dl class="distr">
			<dd>stone  13888888888 <span style="margin-left: 30px">广州市天河区</span></dd>
		</dl>
	</div>
	...
	<div class="box bg_white pb">
		...
		<tbody>
			<tr>
				<td>20151029114530080</td>
				<td class="img48x20">
					<span class="inb"><img src="/res/img/pic/yu8.jpg"></span>
					<a target="block" href="javascript:void(0);">  喜悦2014秋冬新款瑜伽服三件套装 韩版女士瑜珈舞蹈服 愈加服正品送胸垫 酒红+黑+黑 M 开启年终大促 全场优惠到底 买贵就赔 支持货到付款--西瓜红</a>
				</td>
				<td>￥333.01元</td>
				<td>x1</td>
				<td>88</td>
			...
			<tr>
				<td>20151029114530080</td>
				<td class="img48x20">
					<span class="inb"><img src="/res/img/pic/gouwu2.jpg"></span>
					<a target="block" href="javascript:void(0);"> 正品瑞士军刀威戈Wenger梦野款男女15寸电脑包双肩包背包书包支持货到付款</a>
				</td>
				<td>￥235.0元</td>
				<td>x1</td>
				<td>333</td>
			...
			<tr>
				<td>20151029114530080</td>
				<td class="img48x20">
					<span class="inb"><img src="/res/img/pic/gou1.jpg"></span>
					<a target="block" href="javascript:void(0);"> 泰国明星同款原宿软妹薯片包手拿斜挎包趣味包零食包手机零钱女包  买贵就赔 支持货到付款- 大包</a>
				</td>
				<td>￥121.0元</td>
				<td>x1</td>
				<td>66</td>
