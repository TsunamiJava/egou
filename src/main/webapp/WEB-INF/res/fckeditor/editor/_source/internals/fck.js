...
var FCK =
{
	...
	Preview : function()
	{
		...
		if ( FCKConfig.FullPage )
		{
			if ( FCK.TempBaseTag.length > 0 )
				thtml = FCK.TempBaseTag + FCK.GetXHTML() ;
			else
				thtml = FCK.GetXHTML() ;
		}
		else
	...
	SwitchEditMode : function( noUndo )
	{
		...
		if ( bIsWysiwyg )
		{
			...
			thtml = FCK.GetXHTML( FCKConfig.FormatSource ) ;
