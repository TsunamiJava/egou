...
FCKUndo.SaveUndoStep = function()
{
	...
	var thtml = FCK.EditorDocument.body.innerHTML ;
	...
	if ( this.CurrentIndex > 0
			&& thtml == this.SavedData[ this.CurrentIndex ][0]
	...
	else if ( this.CurrentIndex == 0 && this.SavedData.length && thtml == this.SavedData[0][0] )
	{
	...
	this.SavedData[ this.CurrentIndex ] = [ thtml, bookmark ] ;
